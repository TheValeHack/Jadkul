...
class _AddClassPageState extends State<AddClassPage> {
  ...
  void _saveAddClass(){
    ...
    List newScheduleData = [...db.scheduleData[db.activeScheduleIndex]["schedule_data"][db.activeDayIndex]];
    newScheduleData.add(_formData);
    db.scheduleData[db.activeScheduleIndex]["schedule_data"][db.activeDayIndex] = newScheduleData;
    db.updateDatabase();
    Navigator.pushNamed(context, "/mainpage");
  }
